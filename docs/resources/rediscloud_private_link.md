...
locals {
  rediscloud_subscription_name       = "my-subscription"
  rediscloud_cloud_account           = "my-cloud-account"
  rediscloud_private_link_share_name = "my-private-link"
}
...
resource "rediscloud_subscription" "subscription" {
  ...
  cloud_provider {
    ...
    region {
      ...
      preferred_availability_zones = ["euw1-az1"]
    }
  }

...
// have been destroyed. This uses terraform-plugin-testing types and should be used
// by tests that have been migrated to the terraform-plugin-testing framework.
